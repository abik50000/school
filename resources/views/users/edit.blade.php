                        ...
                        <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group focused">
                                    <label class="form-control-label" for="input-lastname">Role</label>
                                    <select name="role" id="" class="select-js">
                                        <option value="2" @if($user->role == 2) checked @endif>Student</option>
                                        <option value="3" @if($user->role == 3) checked @endif>Teacher</option> 
                                    </select>
