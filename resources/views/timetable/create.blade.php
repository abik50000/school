                            ...
                            <div class="pl-lg-4"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date datepicker" id="datetimepicker3" data-target-input="nearest" data-type="date">
                                                <input class="form-control datetimepicker-input" type="text"  data-target="#datetimepicker3" placeholder="День" id="input-day" name="day">
                                ...
                                <div class="form-group focused">
                                    ...
                                    <select name="grade_id" id="" class="select-js">
                                        <option value="" checked>Выберите класс</option>
                                ...
                                <div class="form-group focused">
                                    ...
                                    <select name="subject_id" id="" class="select-js">
                                        <option value="" checked>Выберите предмет</option>
                                ...
                                <div class="form-group focused">
                                    ...
                                    <select name="teacher_id" id="" class="select-js">
                                        <option value="" checked>Выберите учителя</option>
                                ...
                                <div class="form-group focused">
                                    ...
                                    <select name="cabinet_id" id="" class="select-js">
                                        <option value="" checked>Выберите кабинет</option>
