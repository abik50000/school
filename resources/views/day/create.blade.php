                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">Добавить день</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('days.store') }}" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-start">Дата</label>
                                            <div class="input-group date datepicker" id="datetimepicker3" data-target-input="nearest" data-type="date">
                                                <input class="form-control datetimepicker-input" type="text"  data-target="#datetimepicker3" placeholder="Время" id="input-start" name="day">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="">
                                                <option value="0" checked>Учебный</option>
