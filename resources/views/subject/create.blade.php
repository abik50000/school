                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">Добавить предмет</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('subjects.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4"> 
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative" placeholder="Название" value="" required="" autofocus="">
                                    <span class="text-danger">{{ $errors->first('name') }}</span>
                                </div>
                                <div class="form-group focused">
                                    <label class="form-control-label" for="input-class">Класс</label>
                                    <input type="text" name="class" id="input-class" class="form-control form-control-alternative" placeholder="Класс" value="" required="" >
